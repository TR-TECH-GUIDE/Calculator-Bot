...
CALCULATE_TEXT = "Made by @SLBotsOfficial"
...
@SLBotsOfficial.on_message(filters.private & filters.command(["calc", "calculate", "calculator"]))
...
@SLBotsOfficial.on_inline_query()
